...
import { handleRegister } from '../../components/authHandles/handleRegister';
    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <Animated.View
        ...
        <Animated.View
          ...
          onPress={() => handleRegister(username, email, password, confirmPassword, navigation)}>
            ...
            >Sign up</Text>
                ...
                <Animated.View 
                    ...
                    <TouchableOpacity onPress={()=> navigation.navigate('Login')}>
                        <Text style={{color: '#199fff'}}>Click to return</Text>
                    </TouchableOpacity>
                </Animated.View>
                ...
                <Animated.View 
                    ...
                    <TouchableOpacity onPress={()=> navigation.navigate('ResetPassword')}>
                        <Text style={{color: '#199fff'}}>Reset Password</Text>
                    </TouchableOpacity>
                </Animated.View>
            </View>
        </View>
